...
<img src = "{{ site.url}}{{ site.baseurl}}/images/Team/NSamo.jpg" class="img-responsive" width = "20%" style="float: left; margin-right: 10px; margin-bottom: 50px;" />
### Naseem Samo (Postdoctoral researcher)
...
Contact: samonaseem@ku.edu<br>
[Curriculum Vitae]({{ site.url}}{{ site.baseurl}}/docs/CV_NS.pdf){:target="_blank"}
